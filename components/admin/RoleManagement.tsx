...
const CAPABILITIES: Array<{
  ...
  { label: 'Executive Overview', viewKey: 'canViewFinanceReports', editKey: 'canViewFinanceReports' },
  { label: 'Master Inventory', viewKey: 'canEditInventory', editKey: 'canEditInventory' },
  { label: 'Sales & WA Pitch', viewKey: 'canViewDealPrice', editKey: 'canViewDealPrice' },
  { label: 'Pipeline & QC Funnel', viewKey: 'canViewTelegramLink', editKey: 'canViewTelegramLink' },
  { label: 'Invoices & Dokumen Resmi', viewKey: 'canManageInvoices', editKey: 'canManageInvoices' },
  { label: 'Financials & Cashflow', viewKey: 'canViewFinanceReports', editKey: 'canViewFinanceReports' },
  { label: 'Warehouse Intelligence', viewKey: 'canViewSupplierData', editKey: 'canViewSupplierData' },
